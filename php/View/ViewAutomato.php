    ...
    public function montaPaginaAutomato($aEstadosTransicoes, $aTabelaDeTokens) {
        ...
        foreach ($aEstadosTransicoes as $iKey => $aVal) {
            ...
            foreach ($aVal as $iEst => $aExp) {
                ...
                if ($iKey == $iEst) { // $aTabelaDeTokens[$iKey] Verifica se há transição para o próprio estado
                    if ($aExp[0]!='$' || ($aExp[1]==$aTabelaDeTokens[$iKey])) {// || ($aExp[1]==$aTabelaDeTokens[$iKey])
                        $sHtmlTela .= '                                
                                        ...
                                        if (circle.label === "q' . $iKey . '") {
                                            ...
                                            ctx.textAlign = "center";
                                            ctx.textBaseline = "middle";
                                            ctx.fillText("Loop", labelXcurva' . $iKey . ', labelYcurva' . $iKey . ');
                                            ctx.closePath();
                                        }
